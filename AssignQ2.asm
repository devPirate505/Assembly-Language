[org 0x0100]
	...
	outerloop:
		...
		innerloop:
			...
			jbe next		; jump to next if the first digit is below or equal to the next one
		...
		jnz outerloop
			...
			;after converting the numbers into ascending order taking the second largest and second smallest digit

		mov ax, [num + 2] 	
		mov [secSmall], ax	;moving the second smallest digit

		mov ax, [num + 8]
		mov [secLarge], ax	;moving the second largest digit
